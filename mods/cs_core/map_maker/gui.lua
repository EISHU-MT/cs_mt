function map_maker.show_gui(name)
	...
	local formspec = {
		...
		"dropdown[1.15,4.05;1,1;barrier_rot;X=0,Z=0;", context.barrier_rot == "x" and 1 or 2, "]",
		"button[2.3,4;2,1;place_barriers;Place Barriers]",
		"box[4.4,2.8;0.05,2.2;#111111BB]",
		"label[4.8,2.8;3. Place Nodes]",
		"label[4.8,3.3;", minetest.formspec_escape(map_maker.get_node_status()), "]",
		"button[4.8,4;3.5,1;giveme;Giveme Nodes]",
		"box[0,5.06;8.85,0.05;#111111BB]",
		"label[0,5.15;4. Meta Data]",
		"field[0.4,6.2;8.5,1;title;Title;", minetest.formspec_escape(context.maptitle), "]",
		"button[0.1,6.85;4.25,1;a_bomb;(A) Bomb area]",
		"button[4.32,6.85;4.26,1;b_bomb;(B) Bomb area]",
		"field[0.4,8.4;4.25,1;name;File Name;", minetest.formspec_escape(context.mapname), "]",
